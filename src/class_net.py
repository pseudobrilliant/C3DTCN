...
class ClassNet(nn.Module):
    ...
    def __init__(self, cnet_settings, tcn, class_size=13, verbose=False):
        ...
        if self.training:
            self.training_collections = cnet_settings["training_collections"].split(",")
            self.validation_collection = [cnet_settings["validation_collection"]]
    ...
    def save_model(self, temp_epoch=None):
        ...
        filename = "cnet_epochs_{}_batch_{}_frames_{}_learning_{}.pt".format(temp_epoch, self.batch_size,
                                                                             self.num_frames, learning_string)
    ...
    def validate(self, dataset):
        ...
        for batch, labels in data_loader:
            ...
            predictions = torch.max(output.data)
